...
Because [this project](https://github.com/iuliandita/homelab) applies GitOps practices,
it's the source of truth for _my_ homelab, so you'll need to fork it to make it yours:

[:fontawesome-solid-code-fork: Fork iuliandita/homelab](https://github.com/iuliandita/homelab/fork){ .md-button }
